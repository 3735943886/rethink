...
| `https_port`        | `4443`                                   | Thinq2 HTTPS provisioning port.                                                                                                                |
| `mqtts_port`        | `8885`                                   | Thinq2 MQTTS device port.                                                                                                                      |
| `thinq1_https_port` | `46030`                                  | Thinq1 HTTPS provisioning port.                                                                                                                |
| `thinq1_port`       | `47878`                                  | Thinq1 device connection port.                                                                                                                 |
...
If you change one here, also update the matching host port in the add-on's
**Network** panel.
