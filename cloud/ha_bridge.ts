...
import Dev_2RSFL2DBN3K_Z from './devices/2RSFL2DBN3K_Z'
...
const t2deviceTypes: Record<string, T2Factory> = {
    ...
    ['2RSFL2DBN3K_Z']: Dev_2RSFL2DBN3K_Z, // LG Korean refrigerator (deviceType 101), fridge/freezer setpoint + express freeze
